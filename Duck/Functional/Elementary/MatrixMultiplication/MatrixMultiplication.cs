...
namespace Duck.Functional.Elementary.MatrixMultiplication
{
    internal class MatrixMultiplication : BasicFunction<DoubleMatrix>
    {
        ...
        protected override void ApplyGPU(DoubleMatrix p, Matrix result)
        {
            ...
            applyKernel.Run(p.a.GPUValues(), p.b.GPUValues(), result.GPUValues());
        }
        ...
        {
            return (p.a.shape.width, p.b.shape.height);
        }
